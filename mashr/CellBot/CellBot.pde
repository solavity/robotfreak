...
char* driveType = "dfrobot"; // Use "servo" for servos powering the wheels; "motor" when bots has a DC motor driver; "dfrobot" for the kit from RobotShop
...
int m1SpeedControl = 5; //M1 Speed Control
int m2SpeedControl = 6; //M2 Speed Control
int m1DirectionControl = 4; //M1 Direction Control
...
void setup() {
  ...
  if (DEBUGGING) {
      Serial.println("MASHR CellBot V1.0");
  }
